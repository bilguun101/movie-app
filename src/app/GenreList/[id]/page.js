...
import { MovieList } from "@/app/_componentOfHomePage/MovieCard";
...
export default function GenreList() {
    ...
    const getGenreData = async () => {
        const data = await fetch(`https://api.themoviedb.org/3/discover/movie?language=en&with_genres=${id}&page=1`, options);
        const jsonData = await data.json();
        console.log("genreItem", jsonData);
